...
def insert_objective():
    ...
    user.insert_objective(objective)
    open_menu()
...
def log_objective(): 
    ...
    selected_objective = [obj for obj in user.plan if obj.little.lower() == option.lower()]
    ...
    selected_objective[0].record.time(expected_hours)
    open_menu()
